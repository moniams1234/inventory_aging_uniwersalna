...
/* ─── Bucket badge list in sidebar (default) ─────── */
.bucket-badge {
...
/* Compact inputs ONLY inside custom-bucket section */
[data-testid="stSidebar"] .cb-inputs [data-testid="stNumberInput"] > div {
...
[data-testid="stSidebar"] .cb-inputs label {
    font-size: 0.68rem !important;
    margin-bottom: 1px !important;
    padding-bottom: 0 !important;
}

/* Remove button — small, subtle red */
...
/* Add-bucket button — smaller, ghost style */
...
/* Override global sidebar button style for cb-* wrappers */
