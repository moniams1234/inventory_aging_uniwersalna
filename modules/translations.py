...
TRANSLATIONS = {
    "pl": {
        "app_title":    "Inventory Aging Analytics",
        "app_subtitle": "Profesjonalna analiza wiekowania zapasów, segmentacja stanów magazynowych i raportowanie do Excela.",
        "app_tagline":  "Turn raw inventory data into clear aging insights.",
        "language_label": "Język / Language",
        "sidebar_title":  "⚙️ Konfiguracja",
        "powered_by":     "Powered by FA Fin Apps",

        # Hero features
        "feat_fast":    "Szybka analiza",
        "feat_buckets": "Elastyczne przedziały",
        "feat_report":  "Raportowanie ilościowe i wartościowe",
        "feat_excel":   "Eksport do Excela",
        "feat_batch":   "Analiza wg partii i magazynu",
        "hero_cta":     "Wczytaj dane, aby rozpocząć analizę",

        # Sidebar nav
        "nav_upload":   "📂 Dane wejściowe",
        "nav_mapping":  "🗂️ Mapowanie",
        "nav_aging":    "⚙️ Ustawienia",
        "nav_buckets":  "📊 Przedziały",
        "nav_export":   "⬇️ Eksport",
        ...
        "bucket_from":          "Od dnia",
        "bucket_to":            "Do dnia",
        "bucket_to_help":       "Pozostaw 0 dla ostatniego otwartego przedziału",
        "bucket_add":           "➕ Dodaj przedział",
        "bucket_remove":        "Usuń",
        "bucket_last_unlimited":"Ostatni przedział jest nieograniczony",
        "bucket_error_title":   "Błąd w przedziałach",
        "bucket_error_overlap": "Przedziały nakładają się lub są nieprawidłowe!",
        "bucket_error_order":   "Zakresy muszą być rosnące i nie mogą się nakładać!",
        "bucket_warn_gap":      "Ostrzeżenie: wykryto lukę między przedziałami",
        "bucket_error_multi_open":  "Tylko ostatni przedział może mieć puste 'Do dnia'.",
        "bucket_error_empty_name":  "Przedział {n}: nazwa jest pusta.",
        "bucket_error_invalid_from":"Przedział {n}: nieprawidłowy 'Od dnia'.",
        "bucket_error_to_lte_from": "Przedział '{name}': 'Do dnia' > 'Od dnia'.",
        "bucket_error_overlaps":    "Przedział '{name}': nakłada się z poprzednim.",
        "bucket_error_none":        "Brak zdefiniowanych przedziałów.",
        "bucket_error_only_one_open":"Tylko jeden przedział może być otwarty.",
        ...
        "kpi_total_records": "Liczba rekordów",
        "kpi_total_qty":     "Łączna ilość",
        "kpi_total_value":   "Łączna wartość",
        "kpi_materials":     "Indeksów",
        "kpi_warehouses":    "Magazynów",
        "kpi_batches":       "Partii",
        ...
        "chart_top10_val":     "Top 10 wg wartości",
        ...
        "chart_total_qty_label": "Łączna ilość",
        ...
        # Info
        "info_no_value_col":  "ℹ️ Kolumna wartości nie zmapowana — pominięto wiekowanie wartościowe.",
        "info_no_wh_col":     "ℹ️ Kolumna magazynu nie zmapowana — pominięto podsumowanie wg magazynu.",
        "info_batch_required":"⚠️ Przy wiekowaniu wg partii, kolumna partii jest wymagana.",
        ...
        "instructions":        "Wczytaj plik Excel lub CSV z danymi magazynowymi, aby rozpocząć analizę.",
    ...
    "en": {
        "app_title":    "Inventory Aging Analytics",
        "app_subtitle": "Professional inventory aging analysis, stock segmentation and Excel-ready reporting.",
        "app_tagline":  "Turn raw inventory data into clear aging insights.",
        "language_label": "Język / Language",
        ...
        "feat_buckets": "Flexible aging buckets",
        "feat_report":  "Quantity and value reporting",
        "feat_excel":   "Excel export",
        "feat_batch":   "Batch and warehouse analysis",
        "hero_cta":     "Upload your data to start the analysis",

        # Sidebar nav
        "nav_upload":  "📂 Data Input",
        "nav_mapping": "🗂️ Mapping",
        "nav_aging":   "⚙️ Settings",
        "nav_buckets": "📊 Buckets",
        "nav_export":  "⬇️ Export",
        ...
        "bucket_from":           "From day",
        "bucket_to":             "To day",
        "bucket_to_help":        "Leave 0 for the final open-ended bucket",
        ...
        "bucket_error_multi_open":  "Only the last bucket can have empty 'To day'.",
        "bucket_error_empty_name":  "Bucket {n}: name is empty.",
        "bucket_error_invalid_from":"Bucket {n}: invalid 'From day'.",
        "bucket_error_to_lte_from": "Bucket '{name}': 'To day' must exceed 'From day'.",
        "bucket_error_overlaps":    "Bucket '{name}': overlaps with previous bucket.",
        "bucket_error_none":        "No buckets defined.",
        "bucket_error_only_one_open":"Only one bucket can be open-ended.",
        ...
        # Dashboard
        "dashboard_header":  "📈 Dashboard",
        "kpi_total_records": "Total Records",
        ...
        "chart_top10_val":     "Top 10 by Value",
        ...
        "chart_total_qty_label": "Total Quantity",
        ...
        "instructions":        "Upload an Excel or CSV file with inventory data to start the analysis.",
