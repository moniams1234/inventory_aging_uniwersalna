...
with st.sidebar:
    ...
    st.markdown(
        ...
        f'letter-spacing:0.06em;color:#CBD5E1;margin-bottom:4px;">{t["method_label"]}</div>',
    ...
    st.markdown(
        f'<div style="font-size:0.68rem;font-weight:700;text-transform:uppercase;'
        f'letter-spacing:0.06em;color:#CBD5E1;margin-bottom:4px;">{t["date_label"]}</div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        f'<div style="font-size:0.68rem;font-weight:700;text-transform:uppercase;'
        f'letter-spacing:0.06em;color:#CBD5E1;margin-bottom:4px;">{t["buckets_type_label"]}</div>',
        unsafe_allow_html=True
    )
    ...
    if bucket_type == t["buckets_default"]:
        ...
        for i, b in enumerate(cb_list):
            ...
            st.markdown(
                f'<div class="cb-range-preview">{rstr} dni / days</div>',
                unsafe_allow_html=True
            )
    ...
    st.markdown("---")
    st.markdown(
        '<div style="font-size:0.68rem;color:#94A3B8;text-align:center;">FA Fin Apps · v1.2 · © 2025</div>',
        unsafe_allow_html=True
    )
